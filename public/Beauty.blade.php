...
<!-- end of modal -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-2"><img src="image jumia2/b8.jpg" style="height: 220px; width: 200px; object-fit:cover; margin-top: 5px">
                <p>NIVEA Perfect and Radiant<br> ₦3,410.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/b1.jpg" style="height: 220px; width: 200px; object-fit:cover; margin-top: 5px">
                <p>NIVEA Perfect and Radiant<br> ₦8,000.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/b3.jpg" style="height: 220px; width: 180px; object-fit:cover; margin-top: 5px">
                <p>MOLPED molped Ultra<br> ₦445.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/b4.jpg" style="height: 220px; width: 190px; object-fit:cover; margin-top: 5px">
                <p>KIKI New Gain LED Display Clipper<br>₦7,499.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/b6.jpg" style="height: 220px; width: 190px; object-fit:cover; margin-top: 5px">
                <p>HANDAIYAN 6pc<br>₦2,500</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/b1.jpg" style="height: 220px; width: 180px; object-fit:cover; margin-top: 5px">
                <p>NIVEA Perfect and Radiant<br> ₦8,000.00</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-2"><img src="image jumia2/bb1.jpg" style="height: 220px; width: 200px; object-fit:cover">
                <p>NOVA 3 in 1 Hair Straightner<br> ₦6,999.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/bb2.jpg" style="height: 220px; width: 200px; object-fit:cover">
                <p>Elf Cover Everything Concealer<br> ₦2,100.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/bb3.jpg" style="height: 220px; width: 180px; object-fit:cover">
                <p>Hair NOW NOW grow<br> ₦2,499.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/AAA.jpg" style="height: 220px; width: 190px; object-fit:cover">
                <p>Hair Straightner<br>₦7,350.00</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/bb5.jpg" style="height: 220px; width: 190px; object-fit:cover">
                <p>Elf Highlighter Glow<br>₦1,500</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/bb6.jpg" style="height: 220px; width: 180px; object-fit:cover">
    ...
    <div class="container" style="margin-bottom: 40px;">
        <div class="row">
            <div class="col-sm-2"><img src="image jumia2/bb7.jpg" style="height: 200px; width: 200px; object-fit:cover">
                <p>NIVEA Perfect and Radiant<br> ₦3,410.00</p>
            </div>
            ...
            <div class="col-sm-2"><img src="image jumia2/bb9.jpg" style="height: 200px; width: 190px; object-fit:cover">
                <p>HANDAIYAN 6pc<br>₦2,500</p>
            </div>
            <div class="col-sm-2"><img src="image jumia2/bb8.jpg" style="height: 200px; width: 180px; object-fit:cover">
                <p>NIVEA Perfect and Radiant<br> ₦8,000.00</p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid" style="background-color: #343434;">
      <div class="row" style="margin: 10px;">
        <div class="col-sm-3">
          ...
          <p style="color:white ;">Help center <br> How to shop on Jumia? <br> Delivery options and timelines?<br> How to return product on
        ...
        <div class="col-sm-3">
          ...
          <p style="color:white ;"> <a href="About.html" >About us</a><br> Jumia careers<br> Jumia express<br> Terms and conditions<br> Privacy policy<br> Jumia
            prime<br> Jumia global<br> Flash sales</p>
        </div>
        <div class="col-sm-3">
          <p style="color:white ; margin-top: 3em ;">MAKE MONEY WITH JUMIA</p>
          <p style="color:white ;"> Sell on jumia<br> Become a sales consultant<br> Become a jumia vendor service provider<br>Become a
